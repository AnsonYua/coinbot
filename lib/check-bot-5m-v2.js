...
export function buildSignalText(summary) {
  return [
    ...
    `candle price band: ${TA_5M_CANDLE_MIN_ENTRY_PRICE} to ${TA_5M_CANDLE_MAX_ENTRY_PRICE}`,
    `candle min edge: ${formatMaybeNumber(TA_5M_CANDLE_MIN_CONSERVATIVE_EDGE, 3)}`,
    ...
    `yes candle: ${summary.yes.candleConfirmed}`,
    ...
    `no candle: ${summary.no.candleConfirmed}`,
